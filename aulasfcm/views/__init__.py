...
from .edificiosView import EdificiosList, EdificiosUpdate, EdificiosCreate, EdificiosDelete, EdificiosDetail, destroy_gestor_edificio
from .entidadesView import EntidadesList, EntidadesUpdate, EntidadesCreate, EntidadesDelete, EntidadesDetail
from .usuariosView import PasswordChangeView, CustomPasswordChangeView, UsuariosUpdate, CustomUsuariosUpdate
